...
def reverse_between(arr, k, l):
    # Извлечение подсписка между K и L
    subarray = arr[k + 1:l]  # Элементы не включая AK и AL
    subarray.reverse()  # Переворот подсписка
...
A = [10, 20, 30, 40, 50, 60, 70, 80, 90]  # Пример списка
